    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-cover bg-center h-96 text-white flex items-center justify-center relative bg-[url(../assets/mainPage3.jpg)]">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="text-lg">Welcome to Threads Gazette, where fashion becomes a narrative. Our platform, known as the Style Chronicles, is a dynamic space dedicated to unveiling the latest trends and insights in the ever-evolving world of style. At Threads Gazette, we believe that fashion is not just about clothing; it's a language, a form of self-expression. Dive into our curated collection of stories that capture the essence of contemporary trends, offering insights into the artistry behind each outfit. Whether you're seeking inspiration for your next look or eager to stay ahead of the fashion curve, Threads Gazette is your go-to destination for an immersive exploration of style. Join us on this sartorial journey as we navigate the diverse landscape of fashion, revealing the stories behind the trends that shape our evolving aesthetic world</p>
        </div>
      </header>
